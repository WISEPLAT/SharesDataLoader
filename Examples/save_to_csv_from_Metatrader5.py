...
if __name__ == '__main__':
    ...
    # create CSV file
    load_data.ExportToCsvFromMetatrader(ticket=ticket, timeframe=timeframe, utc_till=utc_till, how_many_bars=how_many_bars, remove_last_bar=True, export_dir="csv", prefix=prefix, upper_heading=False)
    ...
    # # print(data)
    # load_data.ExportToCsvFromDb(ticket, timeframe, how_many_bars, export_dir="csv", prefix=prefix, upper_heading=True)
