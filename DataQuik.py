...
class DataQuik():
    ...
    def ExportToCsvFromQuik(self, qpProvider, ticker, timeframe, utc_till, how_many_bars, remove_last_bar, export_dir, prefix='', upper_heading=False, file_ext='csv', sep=','):
        """
